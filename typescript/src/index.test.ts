...
describe.each<ServiceYear>([2020, 2021, 2022])("calculatePrice.zero (%i)", (year: ServiceYear) => {
...
describe.each<[ServiceType, ServiceYear, number]>([
...
describe.each<[ServiceYear, number]>([
    [2020, 300],
    [2021, 300],
    [2022, 0]
